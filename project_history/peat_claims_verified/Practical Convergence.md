...
The single highest-leverage dietary change. [[pufa|PUFA]] damages mitochondrial membranes (cardiolipin peroxidation), suppresses [[thyroid]] function (T4 displacement from carriers), amplifies [[estrogen]] (SHBG displacement), promotes [[serotonin]] (tryptophan displacement from albumin), and generates the reactive aldehydes that poison Complex IV. Removing it improves the system from multiple directions simultaneously.
...
[[thyroid|T3]] is the master throttle — it controls respiratory enzyme expression at both the nuclear and mitochondrial genome levels. Without adequate T3, no other intervention fully works. With adequate T3, many problems self-correct: cholesterol converts to pregnenolone (enabling progesterone), the liver clears estrogen, CO2 production rises (suppressing serotonin), metabolic rate maintains itself, and [dopamine neuron function is supported](https://www.nature.com/articles/s41598-019-49876-6) — which tonically suppresses prolactin via [D2 receptors on pituitary lactotrophs](https://www.ncbi.nlm.nih.gov/books/NBK507829/). Hypothyroidism elevates prolactin through [TRH stimulation, reduced prolactin mRNA suppression, and impaired dopaminergic tone](https://pmc.ncbi.nlm.nih.gov/articles/PMC11697664/); thyroid treatment normalizes it. This means thyroid support is simultaneously an anti-prolactin strategy — no separate prolactin intervention is needed.

**In practice:** Adequate nutrition (glucose, protein, minerals, especially selenium, zinc, iodine). Zinc is essential for [thyroid peroxidase expression (via TTF-2)](https://econtent.hogrefe.com/doi/10.1024/0300-9831/a000262), thyroglobulin synthesis, and as a [deiodinase cofactor alongside selenium](https://econtent.hogrefe.com/doi/10.1024/0300-9831/a000262) — the thyroid system requires iodine (substrate), selenium (deiodinase catalytic site), and zinc (TPO expression and deiodinase cofactor) simultaneously. Selenium is particularly critical: it serves dual functions as a required catalytic component of both the [deiodinase enzymes](https://pmc.ncbi.nlm.nih.gov/articles/PMC12672807/) (DIO1/DIO2 for T4→T3 conversion) and [GPX4](https://pmc.ncbi.nlm.nih.gov/articles/PMC9027222/) (the primary enzymatic defense against [[iron#Claim 1|ferroptosis]]). Selenium deficiency simultaneously impairs thyroid activation and PUFA peroxidation defense — two of the vault's most critical systems from a single mineral deficit. Remove thyroid suppressors (PUFA, chronic stress, endotoxin). If supplementation is indicated, the T4-to-T3 conversion problem means T4-only therapy may be insufficient for the 15-25% of patients with impaired conversion.

> [!tip] Topic-specific detail
> See [[thyroid#Practical Implications]] for the TSH diagnostic critique, T3 vs T4 therapy, the meal test protocol, and physiological monitoring (temperature + pulse).

### 3. Oppose Estrogen with Progesterone
...
**In practice:** Adequate carbohydrate from fruit, sugar, milk, honey. Avoid chronic low-carb and ketogenic approaches that force sustained fat oxidation. Sugar is not the metabolic villain — it is the preferred fuel whose complete oxidation produces the most CO2 per breath. Note: favoring glucose oxidation increases the demand for the cofactors that make it work. PDH — the gatekeeper enzyme at the metabolic fork where pyruvate either enters the mitochondria (→ CO2) or diverts to [[lactate]] — requires three cofactors simultaneously: **thiamine (B1)** as [thiamine pyrophosphate](https://pmc.ncbi.nlm.nih.gov/articles/PMC10731935/), **magnesium** for [PDH phosphatase activation and Mg-ATP function](https://pmc.ncbi.nlm.nih.gov/articles/PMC5786912/) ([~50% of Americans consume below the EAR for magnesium](https://pmc.ncbi.nlm.nih.gov/articles/PMC5786912/)), and **NAD+** as the electron carrier whose product (NADH) feeds Complex I of the ETC. Without any one of these, increased carbohydrate intake produces more pyruvate that cannot be oxidized, paradoxically increasing lactate. B1 also serves alpha-ketoglutarate dehydrogenase and transketolase. Adequate B1, magnesium, and niacinamide (B3, the NAD+ precursor — see [[serotonin#Practical Implications]]) from whole foods or supplementation ensures the "favor glucose" intervention produces CO2 rather than lactate.
...
**Niacinamide (vitamin B3)** complements amino acid balance from a different angle. It supports NAD+ — the [central electron carrier of the ETC](https://pmc.ncbi.nlm.nih.gov/articles/PMC7053056/) (NADH feeds Complex I) — while indirectly diverting tryptophan away from [[serotonin]] synthesis toward the [kynurenine pathway](https://pmc.ncbi.nlm.nih.gov/articles/PMC5398323/). Niacinamide also [inhibits PARP-1](https://pmc.ncbi.nlm.nih.gov/articles/PMC6740200/), preventing the NAD+ depletion that occurs during stress-induced DNA damage. Like [[iron#Claim 8|selenium]] (deiodinases + GPX4), niacinamide serves two of the framework's critical systems from a single nutrient: the electron transport chain AND serotonin regulation.

> [!tip] Topic-specific detail
> See [[serotonin#Practical Implications]] for the SSRI informed-consent point, the depression-as-energy-problem reframe, and anti-serotonin substances. See [[iron#Claim 8]] for the GPX4/glutathione/glycine connection to ferroptosis defense. See [[sugar#Claim 2]] for the three PDH cofactor dependencies (B1, Mg²⁺, NAD+).
...
The [[co2|CO2]]/[[lactate|lactate]] ratio is the most fundamental readout. Rising CO2, falling lactate = the system is shifting toward oxidative metabolism. All other markers reflect this same shift.
...
**Pulse.** Resting pulse ~85 BPM reflects adequate metabolic rate. Both abnormally low and abnormally high can indicate hypothyroidism (the latter from adrenaline compensation). When supplemented with thyroid, elevated pulse normalizes downward.

**The combination.** Temperature + pulse together distinguish genuine metabolic adequacy (warm, moderate pulse) from stress-compensated hypothyroidism (warm from adrenaline, high pulse) and decompensated hypothyroidism (cold, low pulse).

**The meal test.** Temperature and pulse before and after breakfast. In healthy people, both rise after eating. In hypothyroid people, either or both may fall (adrenaline compensation withdrawing as blood sugar normalizes).

**End-tidal CO2.** Should approach 5-6% of expired air when thyroid-driven glucose oxidation is adequate. The most direct single measurement of metabolic state.

**Blood lactate.** Clinical ranges: normal (<2 mmol/L), mild elevation (2-4), severe (>4). In combination with CO2, captures the metabolic fork directly.

> [!tip] Full diagnostic discussion
> See [[thyroid#Claim 3|Thyroid Claim 3]] for the complete physiological markers analysis and the TSH diagnostic critique.
