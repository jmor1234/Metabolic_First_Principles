...
- **State-dependent damping** — every negative feedback mechanism depends on ATP for the machinery that performs it (synthesis, folding, trafficking, cofactor regeneration), even when the regulatory act itself is thermodynamically free. This unifies feedback failure across otherwise independent systems (HPT, HPA, antioxidants, biogenesis, autophagy, hepatic regeneration, lactate clearance) under a single coupling currency. One of several mechanisms generating bistability here — alongside ultrasensitivity, mutual inhibition, and saturation of positive feedback — and distinctive for the cross-system unification. See The System.md.
