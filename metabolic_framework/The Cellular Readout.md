...
> [!abstract] Essence
> Calcium distribution is not a cause or consequence of metabolic state — it IS the state, expressed as ion concentrations: a healthy cell maintains a 10,000:1 gradient (100 nM cytoplasmic vs 2 mM extracellular) via ATP-dependent pumps (SERCA, PMCA, NCX) that consume a substantial fraction of the cell's energy budget, and the transition from ATP-Mg²⁺ (relaxed, high-energy molecular complex) to ADP-Ca²⁺ (excited, low-energy complex) IS the molecular event of cellular decline — not a metaphor for it.
> The calcium paradox resolves systemically, not dietarily: low dietary calcium does not lower serum calcium (PTH pulls it from bone to maintain the tightly regulated serum level), but chronic PTH elevation simultaneously induces glycolysis, causes bicarbonate loss in urine, triggers mast cell degranulation, and compromises cellular energy — so the mobilized calcium deposits in soft tissues whose pumps can no longer exclude it, producing the simultaneous osteoporosis + arterial calcification that defines the bone-vascular axis (dairy is protective, bolus supplements are not, because the mechanism is about PTH dynamics, not calcium arithmetic).
> The acute/chronic distinction operates sharply at PTH: intermittent PTH (teriparatide, FDA-approved for osteoporosis) induces 19 genes and builds bone; continuous PTH induces 173 genes and runs the full destructive program (resorption, glycolysis, bicarbonate loss, mast cell activation) — same molecule, qualitatively different gene program, opposite clinical outcome.
> Bone aging is renewal failure, not mineralization failure: aged bone has more mineral and less collagen (bones become brittle, not soft), bisphosphonates raise DEXA density scores while producing atypical femur fractures (dense, brittle bone whose renewal has been pharmacologically suppressed), and the phenomenon parallels sarcopenia, baldness, and neurodegeneration as systemic expressions of the same impaired oxidative metabolism; the T3/T4 distinction matters here too (T3 is 50-fold more potent than T4 for bone formation).
> Klotho/FGF23 is the clearest modern validation of the phosphate-aging connection: Klotho deficiency produces premature aging (vascular calcification, osteoporosis, atrophy, shortened lifespan) and its primary function is renal phosphate excretion — the most powerful known "anti-aging" protein is fundamentally a phosphate excretor, which matters because phosphate additive intake has doubled since the 1990s (500 → 1000 mg/day; inorganic additives 80-100% absorbed vs 40-60% from natural foods), making the Ca/P ratio and the CO₂-driven blood-pH conditions that regulate them load-bearing for long-term tissue trajectory.
...
The evidence on calcium plus vitamin D supplementation for fractures is mixed. An [earlier NOF meta-analysis](https://pmc.ncbi.nlm.nih.gov/articles/PMC4715837/) reported 15% reduction in total fractures and 30% reduction in hip fractures. However, a [more recent meta-analysis of 11 RCTs (43,869 postmenopausal women)](https://pmc.ncbi.nlm.nih.gov/articles/PMC12506016/) found no significant fracture reduction (RR 0.95, CI 0.85-1.07). The benefit, where observed, may operate through PTH suppression — adequate calcium keeps the parathyroid glands quiet, preventing the systemic metabolic damage that chronic PTH elevation produces. The supplementation question is less important than the dietary adequacy question: the framework's concern is with chronic PTH elevation from inadequate calcium, not with whether supplements reduce fractures in already-adequate populations.
...
Chronic PTH elevation induces glycolysis in bone cells and drives lipolysis and thermogenic programming in adipocytes. It causes bicarbonate to be lost in urine, reducing the CO2 buffering capacity that protects calcium distribution (see next section). It increases IL-6 production — the cytokine that stimulates bone resorption, is stimulated by and stimulates serotonin, and amplifies prolactin. Most remarkably, PTH [triggers mast cell degranulation, releasing both serotonin and histamine](https://pubmed.ncbi.nlm.nih.gov/6191761/) in rat peritoneal mast cells in a dose-, time-, and energy-dependent manner — though the effective concentrations (25 units/ml) are within the range of advanced uremia, not moderate dietary deficiency. Whether the moderate PTH elevations from dietary calcium inadequacy (~65-100 pg/mL) are sufficient to trigger mast cell activation in humans has not been directly tested. The causal chain from calcium deficiency to conservation signaling mediators ([[Conservation Signaling]]) — inadequate dietary calcium → elevated PTH → mast cell activation → serotonin and histamine release → metabolic suppression — is mechanistically plausible but the quantitative threshold in humans is unknown.
