...
- [x] Progesterone — Phases 2 and 3 redone. Key changes: pregnenolone steal mechanism corrected (HPA axis suppression of gonadal function, not substrate competition — no shared adrenal pregnenolone pool). Anti-excitation and cortisol reduction mechanisms operate through allopregnanolone/GABA, not direct progesterone action. Mitochondrial effects confirmed through PGRMC1/PR-M. Cell differentiation confirmed as "ultimate endometrial tumor suppressor." Chemical conflation sourced with market data ($6.9B progestin market, 16% micronized progesterone market share, meta-analysis of 86,881 women). Phase III TBI trial failures attributed to design, not biology.
- [x] Thyroid — Phases 2 and 3 redone. Key changes: T3 dual genome regulation confirmed (p43 mitochondrial receptor). Brain T3 mechanism is local D2 conversion, not direct concentration from serum. TSH diagnostic critique confirmed through NTIS, ETCO2 finding (lower in hypothyroidism, no correlation with TSH/fT4), and reference range debate. Overtreatment paradox documented (21M unnecessary Rx while 10-25% remain symptomatic). DIO2 Thr92Ala (12-30%) explains mixed combination therapy results. Anti-thyroid environment confirmed for each suppressor independently. Barnes' 30-40% prevalence unsupported. Physiological markers individually supported but untested as combined protocol. FDA 2025 enforcement against desiccated thyroid documented. Research context sourced with levothyroxine market ($4.4B), prescription data (102.6M), DIO2 genetics, NTIS literature.
- [x] Serotonin — Phases 2 and 3 redone. Key changes: Conservation mediator role confirmed (brain ATP fall, glycolysis activation, hypothermia via decreased metabolic heat). 5-HT2B valve fibrosis confirmed as indistinguishable from carcinoid. Moncrieff 2022 sourced with methodological criticism. German BGA Prozac rejection confirmed. Kirsch placebo analysis confirmed (82% duplication). SSRI-allopregnanolone mechanism confirmed as alternative therapeutic pathway. SSRI non-selectivity claim NOT supported. Brain serotonin increasing with aging NOT confirmed (receptors decline). Serotonin-cortisol feedback more complex than positive loop. CO2-serotonin pH mechanism confirmed at each link but untested as system. Tryptophan restriction confirmed with food consumption confound caveat. Research context sourced with antidepressant market ($17-20B, SSRIs 43-48% share).
- [x] CO2 — Phases 2 and 3 redone. Key changes: CO2 ROS suppression confirmed (Bolevich/Kogan 2016). Neuroprotection confirmed dose-dependently (mild/moderate protective, severe harmful). Carbamino bonds confirmed as real proteome-wide chemistry (Nature Comms 2018); aldehyde protection hypothesis flagged as mechanistically compelling but untested. Hyperventilation seizure provocation confirmed (87-100% in absence epilepsy). Henderson's therapy historically sourced and abandoned for non-scientific reasons. Queen bee longevity attributed to membrane composition not CO2 — corrected from framework's original attribution. Methylation claim rated speculative with no experimental support. Comparative longevity data (naked mole rats, bats) suggestive but confounded. Research context: institutional neglect, no commercial sponsor, no CO2 therapy market.
