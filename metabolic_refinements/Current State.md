...
| Intervention framework | "What does THIS person do?" | **DONE.** Practice.md updated with conditional bistability (regime-dependent strategy), state-dependent damping (M as universal priority), slow/fast variable prioritization, CO₂ reclassification. |
...
11. **Practice.md updated** — conditional bistability (regime-dependent strategy), state-dependent damping (M as universal priority), slow/fast variable prioritization, CO₂ reclassification, corrected loop count. Eight interventions unchanged — architecture reframed, practical content preserved.
...
2. ~~**Updated intervention framework.**~~ **DONE.** Practice.md updated in place with: conditional bistability (two regimes, two strategies section), state-dependent damping (restoring M as universal priority), slow/fast variable prioritization (slow variables determine durability), CO₂ reclassification (readout with Bohr effect, not causal driver), and corrected loop count. Eight interventions and their detail unchanged — the stress test refined the architecture, not the practical recommendations.
