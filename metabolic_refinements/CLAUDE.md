...
- **`Causal Independence in Feedback Loops.md`** — an audit tool for distinguishing causal participants from parallel markers among the metabolites named as drivers in positive feedback loops. Derived from Sub-test 2.A's deeper structural observation (CO₂/ATP stoichiometric coupling at OXPHOS); first-pass generalized as a "Co-Production Principle" (document deleted after triangulation); then stress-tested via two independent agents and rewritten to ground in existing formal machinery: Pearl's do-calculus / screening-off test (Pearl 2009 *Causality*) and conservation relations in Metabolic Control Analysis (Reder 1988; Heinrich & Schuster 1996; Palsson 2003). Replaces the universal "stoichiometric coupling → parallel marker" rule with a four-check operational audit (conservation / mechanism specificity / realizable intervention / quantitative dominance) and a six-category taxonomy (independent driver — specific mechanism / independent driver — quantitative dominance / parallel marker / gated driver / co-driver / indeterminate). Integrated into `metabolic_foundations/Verification Methodology.md` Step 4 as a formal sub-practice on 2026-04-11 — the second methodology improvement produced by Sub-test 2.A, alongside CF-2.A.4's citation deployment audit at Step 5. Source: Stress Test Sub-test 2.A (upstream observation) and the 2026-04-11 triangulation round documented in `Stress Test.md`'s working log.
